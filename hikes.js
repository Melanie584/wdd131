...
function search() {
  ...
  let filteredHikes = hikes.filter(function() {
    return (
      hike.name.toLowerCase().includes(hikeContainer.toLowerCase()) ||
  ...
  sortedHikes = filteredHikes.sort(compareHikes);
...
// this is similar to what we will be doing for this weeks recipe assignment 
