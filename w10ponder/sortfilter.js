...
// gets an array and then helps make a new array function 
...
// .price will sort by price and . productName will sort by product alphebetically 
...
let filteredTraits = animals.filter(seachTraits);

function seachTraits (item) {
